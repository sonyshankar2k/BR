...
(function (global) {
    System.config({
        ...
        map: {
            ...
            '@angular/router/upgrade': 'npm:@angular/router@4.0.2/bundles/router-upgrade.umd.js',
            '@angular/forms': 'npm:@angular/forms@4.0.2/bundles/forms.umd.js',
            '@angular/upgrade': 'npm:@angular/upgrade@4.0.2/bundles/upgrade.umd.js',
            ...
            '@agm/direction': 'npm:@agm/direction@1.0.0-beta.0/core.umd.js',
